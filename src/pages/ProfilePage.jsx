import { User, Mail, Calendar, Code, Trophy, Target, Award, Info, Settings, LogOut } from 'lucide-react';
...
const ProfilePage = () => {
  ...
  const getBadgeColor = (badge) => {
    switch (badge) {
      ...
      case 'Intermediate': return 'from-emerald-500 to-blue-500';
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white pb-32">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Guest Mode Warning */}
        {isGuest && (
          <div className="mb-6 bg-gradient-to-br from-amber-500/10 to-orange-500/10 backdrop-blur-sm border border-amber-500/30 rounded-2xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-neutral-300 mb-4">
                  Your progress is being tracked locally. Create an account to save your progress permanently and access your submission history!
                </p>
                <Link
                  to="/login"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 rounded-xl text-white text-sm font-semibold transition-all"
                >
                  Create Account
                </Link>
              </div>
        ...
        <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 md:p-8 mb-6 hover:border-purple-400/50 transition-all">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className={`inline-flex items-center gap-2 px-5 py-2 rounded-xl font-bold text-white bg-gradient-to-r ${getBadgeColor(user.badge)} shadow-lg mb-6`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-center gap-3 bg-neutral-900/50 border border-neutral-800/50 rounded-xl p-4 hover:border-neutral-700/50 transition-colors">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="font-medium text-sm text-neutral-200 truncate">{user.email}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 bg-neutral-900/50 border border-neutral-800/50 rounded-xl p-4 hover:border-neutral-700/50 transition-colors">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="font-medium text-sm text-neutral-200">{user.joinDate}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 bg-neutral-900/50 border border-neutral-800/50 rounded-xl p-4 hover:border-neutral-700/50 transition-colors">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="font-medium text-sm text-neutral-200">{user.completedChallenges} challenges</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-400">Solve new coding problems</p>
              </div>
            </div>
          </Link>
        ...
        <div className="bg-gradient-to-br from-neutral-900/80 to-neutral-900/40 backdrop-blur-sm border border-neutral-800/50 rounded-2xl p-6 md:p-8">
          ...
          <div className="space-y-4 text-neutral-300 leading-relaxed mb-8">
            <p>
              DevRank is a Progressive Web App designed to help developers improve their programming fundamentals through gamified coding challenges.
            </p>
            <p>
              Solve challenges across three difficulty levels, earn points based on complexity, and watch your skills grow as you climb through the ranks!
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t border-neutral-800/50">
            <div className="text-center p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
              <div className="text-3xl font-bold text-emerald-400 mb-2">Easy</div>
            ...
            <div className="text-center p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl">
              <div className="text-3xl font-bold text-amber-400 mb-2">Medium</div>
          ...
          <div className="mt-8 pt-6 border-t border-neutral-800/50">
            <h3 className="text-lg font-semibold mb-4 text-neutral-200">Badge System</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-neutral-900/50 border border-neutral-800/50 rounded-xl">
                <div className="text-2xl mb-2">🌱</div>
                <div className="text-sm font-semibold text-emerald-400">Beginner</div>
                <div className="text-xs text-neutral-500 mt-1">0-49 pts</div>
              </div>
              <div className="text-center p-4 bg-neutral-900/50 border border-neutral-800/50 rounded-xl">
                <div className="text-2xl mb-2">🎯</div>
                <div className="text-sm font-semibold text-blue-400">Intermediate</div>
                <div className="text-xs text-neutral-500 mt-1">50-99 pts</div>
              </div>
              <div className="text-center p-4 bg-neutral-900/50 border border-neutral-800/50 rounded-xl">
                <div className="text-2xl mb-2">⭐</div>
                <div className="text-sm font-semibold text-purple-400">Advanced</div>
                <div className="text-xs text-neutral-500 mt-1">100-199 pts</div>
              </div>
              <div className="text-center p-4 bg-neutral-900/50 border border-neutral-800/50 rounded-xl">
                <div className="text-2xl mb-2">🏆</div>
                <div className="text-sm font-semibold text-pink-400">Expert</div>
